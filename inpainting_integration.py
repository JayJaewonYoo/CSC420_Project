...
Original file is located at
    https://colab.research.google.com/drive/175VAVwEtdD9sI7WDebyREUT23Of2CiXH
"""
...
class InpaintAlgorithm():
    ...
    def get_person_idx(self, target_p):
        # Debug
        print(np.unique(self.labeled_mask))
...
class PedestrianDetector():
    ...
    def get_frame_masks(self, video_src='pedestrians.avi', video_save_path='display.avi'):
        ...
        while True:
            ...
            print("Detected %d in frame %d." % (len(bboxes), frame_number))
...
cv2.imshow(cv2.bilateralFilter(curr_image,9,75,75))
